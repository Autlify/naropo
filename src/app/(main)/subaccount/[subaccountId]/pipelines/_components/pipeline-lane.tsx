      ...
      {(provided, snapshot) => {
        ...
        return (
          ...
          >
            <AlertDialog>
              <DropdownMenu>
                <div className="bg-bg-secondary/30 h-[700px] w-[300px] px-4 relative rounded-lg overflow-visible flex-shrink-0 ">
                  <div
                    {...provided.dragHandleProps}
                    className="h-14 backdrop-blur-lg bg-bg-secondary/60 absolute top-0 left-0 right-0 z-10 "
                  >
