...
type BillingSection = 'subscription' | 'payment-methods' | 'usage' | 'credits' | 'promotional'  
...
const VALID_SECTIONS: BillingSection[] = ['subscription', 'payment-methods', 'usage', 'credits', 'promotional']
