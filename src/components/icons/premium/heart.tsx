...
const PremiumHeart = ({ className, size = 24, animated = false }: PremiumHeartProps) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={`heart-gradient-${id}`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FB7185" />
          <stop offset="50%" stopColor="#F43F5E" />
          <stop offset="100%" stopColor="#E11D48" />
        </linearGradient>
        <filter id={`heart-glow-${id}`} x="-50%" y="-50%" width="200%" height="200%">
      ...
      <path
        ...
        fill={`url(#heart-gradient-${id})`}
      >
        {animated && <animate attributeName="transform" values="scale(1);scale(1.05);scale(1)" dur="1s" repeatCount="indefinite" />}
      </path>
      
      <ellipse cx="8" cy="7" rx="2.5" ry="2" fill="white" fillOpacity="0.3" />
    </svg>
  )
}

export default PremiumHeart
