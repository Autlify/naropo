...
-- CreateEnum
CREATE TYPE "Plan" AS ENUM ('price_1SyzhnA9USWB0LkI5GGYXpSD', 'price_1SyzhnA9USWB0LkI308wbMvc', 'price_1SyzhoA9USWB0LkI5D4gH5uO', 'price_1SyzhoA9USWB0LkIhhEDcODz', 'price_1SyzhpA9USWB0LkI5WiSJf1L', 'price_1SyzhqA9USWB0LkIApPieSYG', 'price_1SyzhqA9USWB0LkIiGWeC9I7');
...
CREATE TABLE "AgencySettings" (
    "id" TEXT NOT NULL,
    "agencyId" TEXT NOT NULL,
    "entitlementsInheritToSubaccounts" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "SubAccountSettings" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "SubAccountSettings_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "LegalAcceptance_scope_idx" ON "LegalAcceptance"("scope");
...
-- CreateIndex
CREATE UNIQUE INDEX "SubAccountSettings_subAccountId_key" ON "SubAccountSettings"("subAccountId");
...
-- AddForeignKey
ALTER TABLE "SubAccountSettings" ADD CONSTRAINT "SubAccountSettings_subAccountId_fkey" FOREIGN KEY ("subAccountId") REFERENCES "SubAccount"("id") ON DELETE CASCADE ON UPDATE CASCADE;
